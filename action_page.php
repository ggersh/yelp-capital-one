...
$CLIENT_ID = Qg3ykO4Pj6InIZhwPOlHVA;
$CLIENT_SECRET = wo4MLHr8LoOdI5u7KhcgNzEFRJigCxLQ48BGCApdCIzKydAcxZtR2FpnDsMIz45S;
 ...
 * @return   The JSON response from the request
 */
function search($bearer_token, $term, $location, $price, $open_now) {
    $url_params = array();

    $url_params['term'] = $term;
    $url_params['location'] = $location;
    $url_params['price'] = $GLOBALS['PRICE'];
    $url_params['open_now'] = $GLOBALS['OPEN_NOW'];
 ...
 */
function query_api($term, $location, $price, $open_now) {
    $bearer_token = obtain_bearer_token();
    $response = json_decode(search($bearer_token, $term, $location, $price, $open_now));
...
$location = $options['price'] ?: $GLOBALS['PRICE'];
$location = $options['open_now'] ?: $GLOBALS['OPEN_NOW'];
query_api($term, $location, $price, $open_now);
?>
